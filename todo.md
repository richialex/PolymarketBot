...
1. **[Частично сделано: Shadow] Подписываться и следить за обоими исходами рынка.**
   ...
   - Сейчас Shadow работает для каждого открытого BUY во всех трёх режимах
     (`cheap`, `expensive`, `both`) и пишет отдельные baseline/signal-записи в
...
6. **[Частично сделано] Оценивать оба исхода перед выбором стороны.**
   ...
   - Сейчас сторона выбирается настройкой: дешёвая, дорогая либо обе. Это
     позволяет отдельно тестировать режимы, но бот ещё не выбирает сторону
     автоматически по ожидаемому чистому доходу.
